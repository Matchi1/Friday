...
public class GoogleCalendarInfo {
    ...
    public static List<Event> eventsList(Calendar service) throws IOException {
    ...
    public static void serializeEvents(List<Event> events) throws IOException {
    ...
    public static void deserializeEvents(File file) throws IOException {
        var mapper = new ObjectMapper();
    ...
    public static void hello() throws GeneralSecurityException, IOException {
        ...
        var service = new Calendar.Builder(HTTP_TRANSPORT, JSON_FACTORY, getCredentials(HTTP_TRANSPORT))
                ...
                .build();
        var items = eventsList(service);
        serializeEvents(items);
        deserializeEvents(new File("calendar.json"));
        if (items.isEmpty()) {
